...
export const AttendaceReportCard = () => {
    ...
    const handleYearChange = (event) => { setFinYear(event.target.value); };
    const handleForMonth = (event) => { setForMonth(event.target.value); };
    let count = 0;
    for (let index = 2015; index < curYear; index++) {
        yearArray[count++] = "" + index + "-" + (index + 1);
    }
            ...
            <CardBody>
                ...
                <Table>
                    ...
                    <TableRow>
                        ...
                        <TableCell className="text-danger">Start Month: </TableCell>
                        <TableCell >
                            <Select value={forMonth} displayEmpty onChange={handleForMonth} id="forMonthSelect">
                                <MenuItem value={0} >All</MenuItem>
                                <MenuItem value={4} >April</MenuItem>
                                <MenuItem value={5} >May</MenuItem>
                                <MenuItem value={6} >June</MenuItem>
